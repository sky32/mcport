// Lucide icon subset, derived from lucide (ISC License): https://lucide.dev/
// Vendored locally so the Electron renderer remains offline and compatible with the current CSP.
(() => {
  const icons = {
    ...
    trash: '<path d="M3 6h18"/><path d="M8 6V4c0-1 .9-2 2-2h4c1.1 0 2 1 2 2v2"/><path d="M19 6l-1 14c-.1 1.1-1 2-2 2H8c-1 0-1.9-.9-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',
